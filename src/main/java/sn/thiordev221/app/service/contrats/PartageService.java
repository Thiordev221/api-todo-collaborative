...
public interface PartageService {
     ...
     * @param request les infos de l'utilisateur à inviter.
     * @param currentUserId L'identifiant de l'utilisateur qui fait la demande.
     * @return PartageResponse Le partage créé.
     */
    PartageResponse inviterUtilisateur(Long listId, PartageRequest request, Long currentUserId);
     ...
     * @param inviteEmail L'email de l'utilisateur dont le partage doit être révoqué.
     * @param currentUserId L'identifiant de l'utilisateur qui fait la demande.
     */
    void revoquerPartage(Long listId, String inviteEmail, Long currentUserId);
